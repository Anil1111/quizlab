    ...
    public static class DbInitialazer
    {
        public static void Initialize(UserContext context)
        {
            ...
            var answerOptions = new AnswerOption[]
            {
                ...
                new AnswerOption { Question="What stands LCHF for?",Option1="Low Cost High Fat", Option2 = "Low Core High Fiber" , Option3="Low Carb High Fat.", CorrectAnswer="Low Carb High Fat."},

                new AnswerOption { Question="Marabou is a part of a concern of the world biggest chocolate company. What's the company's name?", Option1="Intersnack Group", Option2 = "Orkla Snacks" , Option3="Mondelez International, earlier Kraft foods", CorrectAnswer="Mondelez International, earlier Kraft foods"}
